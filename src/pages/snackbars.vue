...
<template>
  <LayoutAuthenticated>
    ...
    >
      <Card title="Snackbars" :color="activeColors.inverse" noFooter>
        <div class="flex justify-center md:justify-start items-center space-x-2 md:space-x-16 mb-6">
          ...
          <FieldGroup class="block md:hidden" label="Origins">
            <Field v-model="origin" type="select" :color="activeColors.inverse">
          ...
          <FieldGroup class="block md:hidden" label="Direction">
            <Field v-model="direction" type="select" :color="activeColors.inverse">
              <option value="top">Top</option>
              <option value="bottom">Bottom</option>
            </Field>
          </FieldGroup>
          ...
          <FieldGroup class="block md:hidden" label="Position">
            <Field v-model="position" type="select" :color="activeColors.inverse">
              <option value="left">Left</option>
              <option value="right">Right</option>
          ...
          <FieldGroup label="Lifetime">
            <Field v-model="lifetime" :color="activeColors.inverse"></Field>
          </FieldGroup>
        </div>
        <div class="flex justify-center md:justify-start items-center space-x-2 md:space-x-16 mb-6">
          ...
          <FieldGroup class="block md:hidden" label="Colors">
            <Field v-model="color" type="select" :color="activeColors.inverse">
